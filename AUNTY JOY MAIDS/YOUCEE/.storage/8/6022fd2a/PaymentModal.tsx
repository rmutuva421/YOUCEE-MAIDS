      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700">Number: +263 77 123 424</p>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    <strong>Instructions:</strong> Send ${amount} to +263 77 123 424 via PayNow, 
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-green-700">Number: +263 716 123 132</p>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    <strong>Instructions:</strong> Send ${amount} to +263 716 123 132 via OneMoney, 
                    then enter your phone number above and click "Confirm Payment".
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-purple-700">Number: 077 123 424</p>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    <strong>Instructions:</strong> Send ${amount} to 077 123 424 via InnBucks, 
                    then enter your phone number above and click "Confirm Payment".
                  </p>
                </div>
              </CardContent>
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-600 mt-2">
            One-time payment • Full platform access • Second visits only $10
          </p>
        </div>
